...
with st.expander("View Original Dataset Before Cleaning", expanded=False):
    try:
        ...
        total,columns, duplicates = st.columns(3)
        with total:
...
try:
    ...
    total_books, column, average = st.columns(3)
    with total_books:
...
st.markdown("""
- **Remove Duplicates**: Elimnated duplicate book entries
...
- **Calculate book_age_days**: Computd age from publication date
